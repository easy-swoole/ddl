...
class CreateTableTest extends TestCase
{
    public function testCreateTable1()
    {
        ...
        $expectedSql = "CREATE TABLE IF NOT EXISTS `student` (
...
ENGINE = INNODB AUTO_INCREMENT = 100 DEFAULT COLLATE = 'utf8mb4_general_ci' COMMENT = '学生表';";
        $this->assertSame($expectedSql, $stuSql);
    }
    ...
    public function testCreateTable2()
    {
        ...
        $expectedSql = "CREATE TABLE IF NOT EXISTS `course` (
...
ENGINE = INNODB DEFAULT COLLATE = 'utf8mb4_general_ci' COMMENT = '课程表';";
        $this->assertSame($expectedSql, $courseSql);
    }
    ...
    public function testCreateTable3()
    {
        ...
        $expectedSql = "CREATE TABLE IF NOT EXISTS `score` (
...
ENGINE = INNODB DEFAULT COLLATE = 'utf8mb4_general_ci' COMMENT = '成绩表';";
        $this->assertSame($expectedSql, $scoreSql);
    }
}
